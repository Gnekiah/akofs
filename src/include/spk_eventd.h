...
extern struct eventd_io_context* spk_socket_client_new(struct eventd_socket_client*);
extern void spk_socket_client_free();
extern int spk_socket_send(struct eventd_io_context*, void* data, uint64_t size);
