 /*
  * spk_crc32.c -- compute the CRC-32 of a data stream
  *
...
/*********************************************************/
uint32_t spk_crc32(uint32_t crc, const uint8_t* buf, uint32_t len) {
...
uint32_t spk_crc32_combine(uint32_t crc1, uint32_t crc2, uint32_t len2) {
    int n;
    uint32_t row;
